...
class Utils
{
    ...
    private const hintCodes = array(
        ...
        self::START_FAILED => array(
            ...
            'message' => array(Messages::RFA_17_A, Messages::RFA_17_B)
        ),
    ...
    public static function get_known_error(GuzzleException $fault) {
        ...
        return $fault && self::is_known_error_identifier($fault->errorCode) ? $fault->errorCode : self::find_description(self::HINT, $fault ? $fault->hintCode : Messages::RFA_22);
    }
